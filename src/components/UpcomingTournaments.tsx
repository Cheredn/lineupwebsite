    ...
    <section id="tournaments" className="py-24 px-4 sm:px-6 lg:px-8 bg-black relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {displayTournaments.length === 0 ? (
          <div className="py-16 text-center rounded-2xl glass-panel border border-white/10 p-8 max-w-2xl mx-auto">
            <div className="w-14 h-14 rounded-2xl bg-neutral-900 border border-white/10 flex items-center justify-center mx-auto mb-4">
              <Trophy className="w-7 h-7 text-amber-400/80" />
            </div>
            <h3 className="font-display text-xl font-bold text-white mb-2">
              Анонсы новых турниров формируются
            </h3>
            <p className="text-sm text-neutral-400 max-w-md mx-auto mb-6">
              Организаторы готовят регламент и призовой фонд следующего чемпионата. Созданные турниры появятся здесь сразу после публикации.
            </p>
            <a
