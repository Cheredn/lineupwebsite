  ...
  tournaments: [
    {
      id: "lineup-open-1",
      title: "LINEUP OPEN #1",
      subtitle: "Первый чемпионат серии",
      ...
      status: "РЕГИСТРАЦИЯ ОТКРЫТА" as const,
      region: "Европа / СНГ",
      serverLocation: "Франкфурт и Стокгольм (эквивалент 128-tick)",
      antiCheat: "VACnet + серверная проверка целостности",
      entryFee: "Бесплатно",
      registrationDeadline: "19 СЕН 2026, 23:59 МСК",
      maps: ["Mirage", "Inferno", "Nuke", "Anubis", "Ancient", "Dust II", "Train"],
    },
    {
      id: "lineup-weekly-2",
      title: "LINEUP WEEKLY CUP #2",
      subtitle: "Еженедельный кубок",
      game: "Counter-Strike 2",
      format: "5x5 BO1 / Финал BO3",
      teamCount: 16,
      date: "27 СЕН 2026",
      time: "17:00 МСК (CEST)",
      prizePool: "$250 CAD",
      firstPlacePrize: "$200 CAD",
      secondPlacePrize: "$50 CAD",
      status: "СКОРО" as const,
      region: "Европа / СНГ",
      serverLocation: "Франкфурт, Германия",
      antiCheat: "VACnet + клиентский античит",
      entryFee: "Бесплатно",
      registrationDeadline: "26 СЕН 2026, 22:00 МСК",
      maps: ["Mirage", "Inferno", "Nuke", "Anubis", "Ancient", "Dust II", "Train"],
    },
    {
      id: "lineup-invitational",
      title: "LINEUP MASTERS INVITATIONAL",
      subtitle: "Премьерный турнир сезона",
      game: "Counter-Strike 2",
      ...
      time: "16:00 МСК (CEST)",
      prizePool: "$1,500 CAD",
      firstPlacePrize: "$1,000 CAD",
      secondPlacePrize: "$350 CAD",
      status: "СКОРО" as const,
      region: "Европа / СНГ",
      serverLocation: "Стокгольм и Франкфурт",
      antiCheat: "Обязательный клиентский античит + запись POV",
      entryFee: "Квалификация / Инвайты",
      registrationDeadline: "08 ОКТ 2026, 20:00 МСК",
      maps: ["Mirage", "Inferno", "Nuke", "Anubis", "Ancient", "Dust II", "Train"],
    }
  ] as Tournament[],
